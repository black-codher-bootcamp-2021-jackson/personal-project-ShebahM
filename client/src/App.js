...
function App() {
  ...
  <Router>
    <Routes>
      ...
      <Route path="/Profile" element={<Profile isLoggedIn={isLoggedIn} setIsLoggedIn={setIsLoggedIn} username={username} setUserName={setUserName} input={input} setInput={setInput}/>} />
    </Routes>
  </Router>
  );
}
